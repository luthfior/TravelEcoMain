...
import com.example.travelecoapp.databinding.ActivityComboBinding
...
class ComboActivity : AppCompatActivity() {
    ...
    private var _binding: ActivityComboBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityComboBinding.inflate(layoutInflater)
